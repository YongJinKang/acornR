...
```{r code2, echo=TRUE, include=TRUE, warning=FALSE, message=FALSE, fig.height=4, fig.width=5}
...
```{r code3, echo=TRUE, include=TRUE, warning=FALSE, message=FALSE, fig.width=5, fig.height=4}
...
```{r code4, echo=TRUE, include=TRUE, warning=FALSE, message=FALSE, fig.width=5, fig.height=4}
...
```{r code5, echo=TRUE, include=TRUE, warning=FALSE, message=TRUE}
